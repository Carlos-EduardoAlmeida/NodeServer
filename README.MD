...
The server only stores information if they are in accordance with the pre-established scope and does all data processing in JSON and send to mongoDB database.
